...
public class DateUtils {
	...
	public static long duration (MyDate startDate, MyDate endDate)
	{
		...
		{
			return remainingDaysInYear(startDate)+leadingYear(endDate)+daysInInterveningYear(startDate, endDate);
		}
