...
public class DateUtilsTester {
	...
	public static void main(String[] args) {
		...
		ArrayList<TestCase> testData= new ArrayList<TestCase>();
		testData.add(
				new TestCase(
		...
		testData.add(
				new TestCase(
						...
						59));
		testData.add(
				new TestCase(new MyDate(06, 01, 2012),//case12
						new MyDate(06, 03, 2012),
						60));
		
		testData.add(
				new TestCase(new MyDate(06, 02, 2012),//case13
						new MyDate(06, 03, 2012),
						29));
		testData.add(
				new TestCase(new MyDate(22, 01, 2012),//case14
						new MyDate(15, 11, 2012),
						298));
		testData.add(
				new TestCase(new MyDate(6, 2, 2012),//case15
		...
		for(TestCase testCase : testData){
			...
			long obtainedResult = DateUtils.duration(startDate, endDate);
